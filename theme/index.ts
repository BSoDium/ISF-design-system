import { createTheme, virtualColor, type CSSVariablesResolver, type MantineColorsTuple, type MantineTheme } from '@mantine/core';
...
const forest: MantineColorsTuple   = ["#f0faf0","#dff3df","#bde4be","#98d49a","#78c77a","#62bc64","#55b558","#459947","#38883a","#205c22"];
...
const stone: MantineColorsTuple    = ["#f8f6f3","#ede9e3","#d8d0c5","#c1b6a8","#aca08f","#9d9080","#968979","#807264","#726457","#5e5144"];
...
export const isfCssResolver: CSSVariablesResolver = () => ({
  variables: {},
  light: {},
  dark: {
    '--mantine-color-body': '#0F1923',
  },
});
