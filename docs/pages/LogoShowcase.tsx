...
function LogoMark({ bg, textColor, label, size = 48, strokeWidth = 1.5 }: { bg: string; textColor: string; label: string; size?: number; strokeWidth?: number }) {
  return (
    <Stack gap="xs" align="center">
      ...
      >
        <GlobeIcon size={size} color={textColor} strokeWidth={strokeWidth} />
        <Text
          fw={600}
          style={{
            fontSize: '1.25rem',
    ...
    <Box py="xl">
      <Container size="md">
        <Stack gap="xl">
          {/* Title */}
          <div>
            <Title order={1} c="deep-ocean" mb="xs">
              Identité visuelle
            </Title>
          ...
          <div>
            ...
            <Text size="sm" c="dimmed" mb="lg">
              ...
              Cette zone correspond à la hauteur de l&apos;icône du globe.
            </Text>
            <Group justify="center">
              ...
              >
                ...
                <GlobeIcon size={36} color="var(--mantine-color-deep-ocean-7)" strokeWidth={1.5} />
          ...
          <div>
            ...
            <Group gap="xl" align="flex-end">
              <Stack align="center" gap="xs">
                ...
                >
                  <GlobeIcon size={24} color="var(--mantine-color-deep-ocean-7)" strokeWidth={1.5} />
                </Paper>
              ...
              <Stack align="center" gap="xs">
                ...
                >
                  <GlobeIcon size={16} color="var(--mantine-color-deep-ocean-7)" strokeWidth={2} />
                </Paper>
          ...
          <div>
            ...
            <SimpleGrid cols={{ base: 1, sm: 2 }} spacing="md">
              ...
              <DoOrDont
                isDo
                description="Utiliser l'icône globe officielle à l'épaisseur de trait (stroke) recommandée."
              />
              <DoOrDont
                isDo={false}
                description="Remplacer l'icône officielle par un autre symbole ou modifier l'épaisseur du trait sans validation."
              />
            </SimpleGrid>
          </div>
        </Stack>
